...
const Pagination = (props) => {
  ...
  for (let i = 1; i <= pagingAndSorting.noOfPages; i = +1) {
    pages.push(
      <Pages
  ...
  const limit = (offset + pagingAndSorting.limit > noOfRatings)
    ? noOfRatings : offset + pagingAndSorting.limit;
  return (
    <Wrapper>
      <Description>
        Displaying
